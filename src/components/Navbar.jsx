...
const Navbar = () => {
  return (
    <div
      className=" fixed  z-[999] w-full px-[4.5vw] py-5 font-['Neue_Montreal'] flex justify-between itema-center  
        ...
        {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
          (item, index) => (
            <motion.a
              ...
              onHoverEnd={(e) => {}}
              key={index}
              className={`text-[1.1vw] capitalize cursor-pointer font-normal ${
                index === 4 && "ml-80"
              }`}
            >
              {item}
