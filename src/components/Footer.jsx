...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className="flex flex-col justify-between h-full w-1/2 font-['Test_Founders_Grotesk_X-Condensed']">
      ...
      <div className="w-1/2 font-['Test_Founders_Grotesk_X-Condensed']">
        <h1 className="text-[9vw] uppercase leading-none -mb-10">
          PRESENTATIONS
        </h1>
        <div className="dets font-['Neue_Montreal'] mt-20">
          <div className="block text-2xl font-normal ">Facebook</div>
          <div className="block text-2xl font-normal ">Instagram</div>
          <div className="block text-2xl font-normal ">Twitter</div>
        </div>
      </div>
    </div>
  );
